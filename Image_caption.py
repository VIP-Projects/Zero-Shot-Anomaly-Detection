...
if __name__ == '__main__':
    ...
    base_name = os.path.abspath(os.path.dirname(__file__))  # 파일 절대경로 반환
    base_image = "./dataset/real_Fall/img/fall024"
    output_json = "./annotation/ori_image_caption.json"
    
    path_data, path_output = os.path.join(base_image), os.path.join(base_name, output_json) 
