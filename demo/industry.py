...
# image caption 
file_path = "/home/jykim/JY_project/Few_Shot/BLIP/annotation/industry/hole.json"

with open(file_path, 'r') as f:
    fall_json = json.load(f)

# image load
path = "./dataset/Industry/hole/"
...
for idx, img_path in enumerate(paths):  
    ...
    plt.axis("off")
    if idx < 9:
        save_img = "./result/hole/hole00" + str(idx+1) + ".png"
    elif 8 < idx < 99:
        save_img = "./result/hole/hole0" + str(idx+1) + ".png"
    else:
        save_img = "./result/hole/hole" + str(idx+1) + ".png"  
